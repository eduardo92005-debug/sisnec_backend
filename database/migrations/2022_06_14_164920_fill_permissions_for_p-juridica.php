...
class FillPermissionsForPJuridica extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPJuridica constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.p-juridica',
            'admin.p-juridica.index',
            'admin.p-juridica.create',
            'admin.p-juridica.show',
            'admin.p-juridica.edit',
            'admin.p-juridica.delete',
            'admin.p-juridica.bulk-delete',
        ]);
