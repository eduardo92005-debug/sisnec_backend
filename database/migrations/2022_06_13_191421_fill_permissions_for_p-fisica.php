...
class FillPermissionsForPFisica extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPFisica constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.p-fisica',
            'admin.p-fisica.index',
            'admin.p-fisica.create',
            'admin.p-fisica.show',
            'admin.p-fisica.edit',
            'admin.p-fisica.delete',
            'admin.p-fisica.bulk-delete',
        ]);
