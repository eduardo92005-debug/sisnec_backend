...
class FillPermissionsForVeiculo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVeiculo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.veiculo',
            'admin.veiculo.index',
            'admin.veiculo.create',
            'admin.veiculo.show',
            'admin.veiculo.edit',
            'admin.veiculo.delete',
            'admin.veiculo.bulk-delete',
        ]);
